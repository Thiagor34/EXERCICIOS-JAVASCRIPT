//constante com nomes dos cavalor participantes do páreo
...
function mostrarCavalo() {
    ...
    //exibe nome, nº de apostas etotal apostado no cavalo
...
function totalizarApostas(numCavalo) {
    ...
    return total        //retorna a soma dos valores apostados numCavalo
}
...
function ganhadorPareo() {
    ...
    btApostar.disabled = true       //desabilita os botões apostas e ganhador
